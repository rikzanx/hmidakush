...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Berita Saya</h1>
    </div>
    ...
    <div class="card shadow mb-4">
      ...
      <div class="card-body">
        ...
        <a href="{{ route('portal.myberita.index') }}" class="btn btn-primary">Kembali</a>
            <br />
            <br />

            <form method="post" action="{{ route('portal.myberita.update',$berita)}}" enctype="multipart/form-data">
