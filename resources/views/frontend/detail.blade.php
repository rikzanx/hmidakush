    ...
    <div class="row pt-5">
      <div class="col-lg-8">
        <div class="d-flex flex-column text-left mb-3">
          ...
          <h1 class="mb-3">Masa Jabatan Kepala Desa 9 Tahun, Bentuk Kekuasaan yang tak Terbatas Untuk
            Terjadinya Korupsi dan Kemiskinan</h1>
          <div class="d-flex">
            <p class="mr-3"><i class="fa fa-calendar text-primary"></i> 25 Januari 2023</p>
            <p class="mr-3">
              <i class="fa fa-tag text-primary"></i> Tulisan Kader
            </p>
            <p class="mr-3"><i class="fa fa-Ulasan text-primary"></i> 15</p>
          </div>
        </div>
        <div class="mb-5">
          <img class="img-fluid rounded w-100 mb-4" src="https://kammi.id/assets/img/post/thumbnail/453bc6074076a4fd768f60617b439fbe.jpg" alt="Image" />
          <p>
        ...
        <div class="mb-5 mx-n3">
          <h2 class="mb-4 ml-3">Posting Terkait</h2>
      ...
      <div class="col-lg-4 mt-5 mt-lg-0">
        ...
        <div class="mb-5">
          <form action="">
            <div class="input-group">
              <input type="text" class="form-control form-control-lg" placeholder="Pencarian" />
        ...
        <!-- Recent Post -->
        <div class="mb-5">
          <h2 class="mb-4">Berita Sebelumnya</h2>
        ...
        <div class="mb-5">
          <img src="https://kammi.id/assets/img/post/thumbnail/453bc6074076a4fd768f60617b439fbe.jpg" alt="" class="img-fluid rounded" />
          <div class="mb-5">
          <h5>Masa Jabatan Kepala Desa 9 Tahun, Bentuk Kekuasaan yang tak Terbatas Untuk
            Terjadinya Korupsi dan Kemiskinan</h5>
